package com.ran.partner.util.HorizontalCalendar;
...
import com.ran.partner.util.HorizontalCalendar.adapter.DaysAdapter;
import com.ran.partner.util.HorizontalCalendar.adapter.HorizontalCalendarBaseAdapter;
import com.ran.partner.util.HorizontalCalendar.adapter.MonthsAdapter;
import com.ran.partner.util.HorizontalCalendar.model.CalendarItemStyle;
import com.ran.partner.util.HorizontalCalendar.model.HorizontalCalendarConfig;
import com.ran.partner.util.HorizontalCalendar.util.CalendarEventsPredicate;
import com.ran.partner.util.HorizontalCalendar.util.HorizontalCalendarListener;
import com.ran.partner.util.HorizontalCalendar.util.HorizontalCalendarPredicate;
import com.ran.partner.util.HorizontalCalendar.util.HorizontalSnapHelper;
import com.ran.partner.util.HorizontalCalendar.util.Utils;
...
public final class HorizontalCalendar {
     ...
     *                  ,or false to play default scroll animation speed.
     */
    private void selectDate(Calendar date, boolean immediate) {
